...

{
   ...
   {
      token &&  <h1 className='my-1 font-semibold' onClick={HandleLogout}>Logout</h1>
   }
         ...
         <div className="bg-gray border border-gray absolute bottom-0 sticky g-50 flex gap-6 sm:hidden w-full py-3 justify-center  ">
