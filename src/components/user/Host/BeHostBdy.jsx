...
<>
        <div className="flex justify-center mt-4">
            <div className=''>
                <div className="font-semibold text-4xl font-sans leading-9 mt-6">Welcome, {clientName}</div>
                ...
                <div className=''>
                    ...
                    <div className='mt-2 border-b-2 border-gray-400 flex p-4'>
                        ...
                        <IoHomeOutline className='text-4xl ml-[-12px] ' /> <span className='justify-center ml-6 text-lg text-black-400 mt-2' onClick={()=>navigate()}> Duplicate the listing </span>
