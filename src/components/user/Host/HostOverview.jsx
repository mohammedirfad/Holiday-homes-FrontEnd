...
Make it stand out</h1>
               ...
               <div className='flex justify-center'>
                <img className='h-32 w-36 justify-center mt-[-5px]' src={overview2} alt="setuping" ></img>
               </div>
            </div>
...
Finish up and publish</h1>
      ...
      <button className=' bg-primary text-white absolute right-0 rounded-md mt-4 justify-center mx-10  w-40 h-11 font-semibold' onClick={()=> {
